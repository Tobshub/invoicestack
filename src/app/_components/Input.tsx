...
export default function FormInput(props: FormInputProps) {
  ...
  return (
    <FormControl error={!!error} sx={horizontal ? { flexDirection: "row", gap: 2, ...controlSx } : controlSx}>
      {label ? <FormLabel sx={horizontal ? { alignSelf: "center" } : undefined}>{label}</FormLabel> : null}
      <Input {...rest} />
